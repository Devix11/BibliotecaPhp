<?php
   ...
   // $_SESSION['user_id'] = $user_id; // Imposta l'ID dell'utente in sessione
    ...
    $db = mysqli_connect('localhost', 'root', '', '5ic');
    ...
    if ($_POST['profile_type'] == "admin") {
        ...
        // You can convert the boolean to an integer (0 or 1)
        $isVerified = true;  // Or false
        $isVerifiedAsInt = $isVerified ? 1 : 0;
        // Bind parameters to the prepared statement
        // "si" stands for the parameters types (String, Integer)
        mysqli_stmt_bind_param($stmt, 'si', $email, $isVerifiedAsInt);
