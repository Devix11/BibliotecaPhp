            ...
            <?php foreach ($books as $book) { ?>
                <tr>
                    <form method="POST" action="update_book.php">
                        <td>
                            <input type="text" name="book_title" value="<?php echo $book['titolo']; ?>"></td>
                            <input type="text" name="book_author" value="<?php echo $book['autore']; ?>"></td>
                            <input type="text" name="book_isbn" value="<?php echo $book['isbn']; ?>"></td>
                            <input type="text" name="book_genre" value="<?php echo $book['genere']; ?>"></td>
                            <input type="text" name="book_year" value="<?php echo $book['annoPubblicazione']; ?>"></td>
                            <input type="text" name="book_availability" value="<?php echo $book['quantita']; ?>"></td>
