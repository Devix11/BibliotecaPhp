...
<html>
    ...
    <?php foreach ($books as $book) { ?>
        <tr>
            ...
            <form method="POST" action="update_book.php" class="w-auto inline-block">
                <td><?php echo $book['id']; ?></td>
                <td><input type="hidden" name="book_id" value="<?php echo $book['id']; ?>"></td>
                <td><input class="w-auto inline-block appearance-none bg-gray border-none text-gray-700 mr-3 py-1 leading-tight focus:text-red-600" type="text" name="newTitle" value="<?php echo $book['titolo']; ?>"></td>
                <td><input class="w-auto inline-block appearance-none bg-gray border-none text-gray-700 mr-3 py-1 leading-tight focus:text-red-600" type="text" name="newAuthor" value="<?php echo $book['autore']; ?>"></td>
                <td><input class="w-auto inline-block appearance-none bg-gray border-none text-gray-700 mr-3 py-1 leading-tight focus:text-red-600" type="text" name="newIsbn" value="<?php echo $book['isbn']; ?>"></td>
